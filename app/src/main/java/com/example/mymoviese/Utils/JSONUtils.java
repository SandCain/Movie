package com.example.mymoviese.Utils;
...
//вся информация про фильм
    ...
    public static final String BACKGROUND_SIZE = "w780";


    public static ArrayList<Review> getReviewsFromNetwork(JSONObject jsonObject) {
    ...
    public static ArrayList<Trailer> getTrailersFromNetwork(JSONObject jsonObject) {
        ...
        try {
            ...
            for(int i = 0; i<jsonArray.length(); i++) {
                ...
                String key = URL_YOUTUBE + jsonObjectTrailers.getString(KEY_KEY_OF_VIDEO);
